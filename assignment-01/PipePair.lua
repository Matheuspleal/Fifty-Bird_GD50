...
-- size of the gap between upper and lower pipes
local GAP_HEIGHT = 90
...
function PipePair:init(y)
    ...
    PIPE_TIMER = math.random(10,50)

    -- initialize pipes past the end of the screen
    self.x = VIRTUAL_WIDTH + PIPE_TIMER
...
function PipePair:update(dt)
    ...
    -- Randomizing the gap between pipes
    GAP_HEIGHT = math.random(85,115)
